...
class AlphaDemo(object):
    ...
    def __init__(self, width=900, height=600, fontsize=14):
        ...
        venus = load_pic("venus.jpg").convert()
        ...
        # per pixel rgba
        self.blend_rgba = [255, 255, 255, 128]
    ...
    def action(self, pressed_keys):
        ...
        red, green, blue, alpha = self.blend_rgba
    ...
    def show_surfaces(self, surf, pictype, x, y, x_delta, height,
        ...
        blend_surf = surf.copy()
        blend_surf = get_alpha_surface(blend_surf, blend_rgba, mode)
        x = x + x_delta
        self.screen.blit(blend_surf, (x, y))
        self.write(x, yh, "%s, blend" % pictype)
